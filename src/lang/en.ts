...
export const en = {
    ...
    success:{
        ...
        accountVerifyPrompt: "Your Account has been created, Verify your account by clicking the url sent to your mail",
        accountVerified: "Your account has been successfully verified",
        passwordChanged: "Password has been changed.",
        accountDeleted: "Your Account has been successfully deleted!",
        passwordResetInfo: "We sent you instructions how to reset your password to your mail address"
    },
    errors: {
        roleNotExisting: "This role does not exist",
        internal: "An internal error has occured, try again later",
        accountCreationPermissionDenied: "You have no permission to create new privileged users",
        accountAlreadyExists: "Account with this address already exists",
        emailNotSent: "There was a problem sending your mail.. Try contacting our administration team to resolve this issue",
